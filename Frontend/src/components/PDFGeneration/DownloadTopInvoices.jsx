...
export const generateHighGSTInvoicesPDF = async (highGstInvoices = []) => {
  ...
  autoTable(doc, {
    ...
    didDrawPage: (data) => {
      ...
      doc.setTextColor(0);
      doc.setFont("helvetica", "bold");
      doc.text("Top GST Invoices List", PAGE_WIDTH / 2, HEADER_HEIGHT + 35, {
        align: "center",
      });
  ...
  drawFooter();
  doc.save("High_GST_Invoices.pdf");
};
